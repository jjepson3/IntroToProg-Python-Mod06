...
# JJepson,2.19.2023,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(str_task, str_priority, list_of_rows):
        ...
        :param str_priority: (string) with name of priority:
        :param list_of_rows: (list) you want to add more data to:
        :return: (list) of dictionary rows
        """
        row = {"Task": str(str_task.strip()), "Priority": str(str_priority.strip())}
        list_of_rows.append(row)
        return list_of_rows

    @staticmethod
    def remove_data_from_list(str_task, list_of_rows):
...
while True:
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        table_lst = Processor.add_data_to_list(str_task=task, str_priority=priority, list_of_rows=table_lst)
        continue  # to show the menu

    elif choice_str == '2':  # Remove an existing Task
        task = IO.input_task_to_remove()
        table_lst = Processor.remove_data_from_list(str_task=task, list_of_rows=table_lst)
        continue  # to show the menu
